    ...
    return (
        <div className="mx-auto max-w-2xl py-40 px-4s sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="bg-image-what">
                ...
                <h4 className="text-lg font-normal text-darkgray text-center mt-4">Our Customers Have Said a Lot About Us—Here Are a Few Highlights . <br /> With Glaze Credit.</h4>
                ...
                <div className="lg:relative">
                    ...
                    <span className="lg:absolute lg:bottom-40 lg:left-80">
                        ...
                        <div className="lg:inline-block bg-white rounded-2xl p-5 shadow-sm">
                            <p className="text-base font-normal text-center text-darkgray">The AI integration was incredibly helpful,<br /> providing personalized support and ensuring <br />I got the best loan for my needs.</p>
                            <h3 className="text-2xl font-medium text-center py-2">LALA TECH</h3>
                            <h4 className="text-sm font-normal text-center">Software Developer</h4>
                        </div>
                    </span>
